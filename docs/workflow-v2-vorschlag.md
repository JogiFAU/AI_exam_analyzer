...
## Vorschlag für Implementierungsreihenfolge (maximaler ROI)
1. **Gate-Objekt im Preprocessing** + harte Sperren für Auto-Korrektur.
2. **Topic Candidate Retrieval (Top-k)** vor Pass A.
3. **Clustering auf Retrieval+Reranking** (nicht nur Union-Find über Jaccard).
4. **Run-Metriken + Reportdatei** zur datengetriebenen Nachkalibrierung.
